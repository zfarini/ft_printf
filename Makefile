SRCS            = ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isascii.c ft_isprint.c ft_strlen.c ft_memset.c  \
                          ...
                          ft_strmapi.c ft_striteri.c ft_putchar_fd.c ft_putstr_fd.c ft_putendl_fd.c ft_putnbr_fd.c main.c
...
${NAME}: ${OBJS}  ft_printf.o ft_printf.c main.c
	${AR} ${NAME} ${OBJS} ft_printf.o 
